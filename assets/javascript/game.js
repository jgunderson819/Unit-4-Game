...
var numberOptions
var imageCrystal;
var crImages = ["./assets/images/crystal 2.jfif","./assets/images/crystal 3.jfif","./assets/images/crystal 4.jfif","./assets/images/crystal 6.jfif"];
...
function crystalAssign() {
      ...
      for (var i = 0; i < numberOptions.length; i++) {
        ...
        imageCrystal.attr("src", crImages[i]);
    ...
    function resetGame() {
      ...
      $(".crystal-image").each(function(i, crystal){
